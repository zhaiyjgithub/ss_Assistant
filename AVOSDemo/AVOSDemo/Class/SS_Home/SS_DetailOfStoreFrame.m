...
#define SYSTEM_WITH  [UIScreen mainScreen].bounds.size.width
...
- (void)setDetailStoreModel:(SS_DetailOfStoreModel *)detailStoreModel
{
    ...
    CGSize instructionSize = [detailStoreModel.instruction sizeWithFont:[UIFont systemFontOfSize:15.0] maxSize:CGSizeMake([UIScreen mainScreen].bounds.size.width - 10, MAXFLOAT)];
    ...
    _addressFrame = CGRectMake(10, 235 + instructionSize.height+5, addressSize.width, addressSize.height);
    
    _imageAndLabelHeight = (235 + instructionSize.height + 5 + addressSize.height);
